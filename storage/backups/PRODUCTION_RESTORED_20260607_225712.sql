...
CREATE TABLE `contract_documents` (
  ...
  `first_party_position` varchar(255) DEFAULT NULL,
  `first_party_company` varchar(255) DEFAULT NULL,
  `first_party_address` text DEFAULT NULL,
  `second_party_name` varchar(255) DEFAULT NULL,
  `second_party_address` text DEFAULT NULL,
  `second_party_ktp` varchar(255) DEFAULT NULL,
  ...
  `contract_value_text` varchar(255) DEFAULT NULL,
  `payment_method` varchar(255) NOT NULL DEFAULT 'Lump Sum',
  `payment_terms` longtext DEFAULT NULL,
  `rights_obligations` longtext DEFAULT NULL,
  `hki_terms` longtext DEFAULT NULL,
  `nda_terms` longtext DEFAULT NULL,
  `sanctions_terms` longtext DEFAULT NULL,
  ...
  `signature_number` varchar(255) DEFAULT NULL,
  `signature_qr_data_uri` longtext DEFAULT NULL,
  ...
  CONSTRAINT `contract_documents_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`),
...
--
-- Table structure for table `employee_portfolios`
--

DROP TABLE IF EXISTS `employee_portfolios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `employee_portfolios` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `employee_id` bigint(20) unsigned NOT NULL,
  ...
  `mime_type` varchar(255) DEFAULT NULL,
  `file_size` bigint(20) unsigned DEFAULT NULL,
  `url` varchar(255) DEFAULT NULL COMMENT 'Alternatif link jika portfolio berbentuk URL bukan file',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `employee_portfolios_uploaded_by_foreign` (`uploaded_by`),
  KEY `employee_portfolios_employee_id_index` (`employee_id`),
  CONSTRAINT `employee_portfolios_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`) ON DELETE CASCADE,
  CONSTRAINT `employee_portfolios_uploaded_by_foreign` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `employee_portfolios`
--

SET @OLD_AUTOCOMMIT=@@AUTOCOMMIT, @@AUTOCOMMIT=0;
LOCK TABLES `employee_portfolios` WRITE;
/*!40000 ALTER TABLE `employee_portfolios` DISABLE KEYS */;
/*!40000 ALTER TABLE `employee_portfolios` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;
SET AUTOCOMMIT=@OLD_AUTOCOMMIT;
...
SET @OLD_AUTOCOMMIT=@@AUTOCOMMIT, @@AUTOCOMMIT=0;
LOCK TABLES `first_parties` WRITE;
/*!40000 ALTER TABLE `first_parties` DISABLE KEYS */;
INSERT INTO `first_parties` VALUES
(1,'PT Lingkar Inovasi Muda','Nama Penanggung Jawab','Direktur','Alamat perusahaan pihak pertama.',1,'2026-06-07 15:49:57','2026-06-07 15:49:57');
/*!40000 ALTER TABLE `first_parties` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;
SET AUTOCOMMIT=@OLD_AUTOCOMMIT;
...
CREATE TABLE `project_files` (
  ...
  CONSTRAINT `project_files_uploaded_by_foreign` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `project_links` (
  ...
  `type` varchar(50) NOT NULL DEFAULT 'other' COMMENT 'github,gitlab,figma,notion,trello,staging,production,docs,other',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `project_links_project_id_index` (`project_id`),
...
CREATE TABLE `project_members` (
  ...
  `project_id` bigint(20) unsigned NOT NULL,
  `employee_id` bigint(20) unsigned NOT NULL,
  `role` varchar(100) DEFAULT NULL COMMENT 'Peran dalam project, cth: Lead Developer, Designer',
  `notes` text DEFAULT NULL,
  `work_status` enum('not_started','in_progress','completed') NOT NULL DEFAULT 'not_started',
...
--
-- Table structure for table `project_work_histories`
--

DROP TABLE IF EXISTS `project_work_histories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `project_work_histories` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `project_id` bigint(20) unsigned NOT NULL,
  `employee_id` bigint(20) unsigned NOT NULL,
  `logged_by` bigint(20) unsigned DEFAULT NULL,
  `from_status` enum('not_started','in_progress','completed') DEFAULT NULL,
  `to_status` enum('not_started','in_progress','completed') NOT NULL,
  `note` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `project_work_histories_employee_id_foreign` (`employee_id`),
  KEY `project_work_histories_logged_by_foreign` (`logged_by`),
  KEY `project_work_histories_project_id_employee_id_index` (`project_id`,`employee_id`),
  CONSTRAINT `project_work_histories_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`) ON DELETE CASCADE,
  CONSTRAINT `project_work_histories_logged_by_foreign` FOREIGN KEY (`logged_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `project_work_histories_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `project_work_histories`
--

SET @OLD_AUTOCOMMIT=@@AUTOCOMMIT, @@AUTOCOMMIT=0;
LOCK TABLES `project_work_histories` WRITE;
/*!40000 ALTER TABLE `project_work_histories` DISABLE KEYS */;
/*!40000 ALTER TABLE `project_work_histories` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;
SET AUTOCOMMIT=@OLD_AUTOCOMMIT;
...
-- Dump completed on 2026-06-07 15:57:12
